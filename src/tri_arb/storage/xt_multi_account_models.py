...
def create_account_table_models(account_id: str):
    ...
    class XTAccountUpdate(Base):
        ...
        __tablename__ = f"xt_account_updates_{table_suffix}"
    ...
    class XTSpotUpdate(Base):
        """XT 现货账户余额快照（账号特定表）."""
        __tablename__ = f"xt_spot_updates_{table_suffix}"
    ...
    class XTPositionUpdate(Base):
        ...
        __tablename__ = f"xt_position_updates_{table_suffix}"
    ...
    class XTOrderUpdate(Base):
        ...
        __tablename__ = f"xt_order_updates_{table_suffix}"
    ...
    class XTTradeUpdate(Base):
        ...
        __tablename__ = f"xt_trade_updates_{table_suffix}"
    ...
    class XTTransfer(Base):
        """XT资金划转记录（账号特定表）."""
        __tablename__ = f"xt_transfers_{table_suffix}"
    ...
    class XTSpotBalance(Base):
        """XT现货账户余额记录（账号特定表）."""
        __tablename__ = f"xt_spot_balances_{table_suffix}"
    ...
    class XTPerpBalance(Base):
        """XT合约账户余额记录（账号特定表）."""
        __tablename__ = f"xt_perp_balances_{table_suffix}"
    ...
    class XTPerpPosition(Base):
        """XT合约账户仓位记录（账号特定表）."""
        __tablename__ = f"xt_perp_positions_{table_suffix}"
    ...
    class XTRestPositionUpdate(Base):
        """XT永续仓位定时更新记录（账号特定表）."""
        __tablename__ = f"xt_rest_position_updates_{table_suffix}"
