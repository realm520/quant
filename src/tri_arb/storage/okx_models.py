...
class OKXAccountBalance(Base):
    ...
    __tablename__ = "okx_account_update"
...
class OKXPosition(Base):
    ...
    __tablename__ = "okx_position_update"
...
class OKXOrder(Base):
    ...
    __tablename__ = "okx_order_update"
    ...
    __table_args__ = (
        ...
        UniqueConstraint(
            "ord_id", "u_time", name="uq_okx_order_id_time"
        ),  # 防止重复订单更新
    )
...
class OKXTrade(Base):
    ...
    __tablename__ = "okx_trade_update"
