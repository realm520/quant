...
class ExchangeProtocol(Protocol):
    ...
    async def get_ticker(self, symbol: str | None = None) -> list[Ticker]: ...  # noqa: E704
...
class ArbitrageMonitor:
    ...
    async def scan_once(self) -> list[ArbitrageOpportunity]:
        ...
        fee_rate = Decimal(str(self.config.fee_rate_per_trade / 100))  # Convert % to decimal
            ...
            try:
                ...
                if profit_rate >= Decimal(str(self.config.min_profit_threshold)):
                    ...
                    recommended_amount = calculate_recommended_amount(
                        ...
                        liquidity_usage_rate=Decimal(str(self.config.liquidity_usage_rate))
                    )
