...
class ZBApi:
    ...
    def call_api(self, url, params=''):
        ...
        while True:
            try:
                r = requests.get(full_url, proxies=self.proxies, timeout=2)
            except Exception:
                time.sleep(0.5)
                continue
            if r.status_code != 200:
...
if __name__ == "__main__":
    z = ZBApi("5b891342-911d-4622-9d68-ee1c0e095d4f", "0a7334c4-6b40-416a-9aa5-68ba20272f58")
    z.set_proxy({
        'http':'127.0.0.1:10809',
        'https':'127.0.0.1:10809'
    })
    ret = z.depth("btc_usdt", 3)
    print(ret)